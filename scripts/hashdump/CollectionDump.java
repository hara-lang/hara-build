...
public class CollectionDump {
   ...
   * instead: the unordered map composition over MapEntry values, identical to
  ...
  static void appendHashesSortedMap(
    ...
    for (Entry<Object, Object> e : m) {
      var entry = new MapEntry<>(null, e.getKey(), e.getValue());
